...
class PayGateDotTo_Instant_Payment_Gateway_Interac extends WC_Payment_Gateway {
	...
	// Handle error
    wc_add_notice(__('Currency error:', 'instant-approval-payment-gateway') . __('Payment could not be processed Store currency must be CAD', 'instant-approval-payment-gateway'), 'error');
    return null;	
