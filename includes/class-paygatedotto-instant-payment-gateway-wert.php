...
if ($paygatedottogateway_wertio_reference_total < 1) {
paygatedottogateway_add_notice(__('Payment error:', 'instant-approval-payment-gateway') . __('Order total for this payment provider must be $1 USD or more.', 'instant-approval-payment-gateway'), 'error');
return null;
}	
